...
public class famf extends AppCompatActivity {
    Button c, d, g,f , a, b;

    private SoundPool soundPool;
    private int sound_a, sound_b, sound_c, sound_d, sound_g,
            sound_f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_famf);
        ...
        sound_b = soundPool.load(this, R.raw.asharpmajor, 1);
