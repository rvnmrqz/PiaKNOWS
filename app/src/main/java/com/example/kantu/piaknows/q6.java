...
public class q6 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if(v==btn1){
            ...
            if(rdo.getText().toString().equals("C Family Chord")){
                MyScore.AddScore();
            }
            Intent in = new Intent(q6.this,q7.class);
            startActivity(in);
            finish();
        }
        }catch (Exception e){
